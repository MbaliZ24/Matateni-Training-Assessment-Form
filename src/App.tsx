...
function CheckboxLine({ label }: { label: string }) {
  return (
    <label className="inline-flex items-center gap-2 text-sm text-slate-700">
      <input type="checkbox" className="size-4 rounded border-brand-line text-brand-ruby focus:ring-red-100" />
      {label}
    </label>
  );
}
      ...
      <div className="mx-auto w-full max-w-6xl px-4">
        ...
        <div className="sticky top-0 z-20 mb-5 rounded-2xl border border-brand-line bg-white/95 px-4 py-4 shadow-sm backdrop-blur md:px-5">
          ...
          <div className="relative pt-1">
            ...
            />
            <div className={`grid gap-1 md:gap-2`} style={{ gridTemplateColumns: `repeat(${visibleSections.length}, minmax(0, 1fr))` }}>
